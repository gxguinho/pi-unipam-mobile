  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Scaffold(
          appBar: AppBar(
            title: !isSearching ? Text("Frequência", style: AppText.barTitle) : 
            TextField(
              onChanged: (text) => FrequencyController.instance.onChangedText(text),
          ...
          body: ScrollableWidget(
            child: DataTable(
              ...
              rows: [
                ...FrequencyController.instance.frequencyFillter.map((e) => 
                  DataRow(
                    cells: [
