          ...
          child: Scaffold(
            ...
            body: Container(
              child: ListView(
                ...
                children: [
                   ...InputModalList().noteInputs.map((e) =>
                      e['isDropdown'] == true ? 
                      DropdownCreate(
                        title: e['title'] as String,
                        itemsSelect: e["itens"] as List<Map<dynamic, dynamic>>,
                        onChanged: (text) => NotesController.instance.aluno = text,
                    ) : InputTextCreate(
                          title: e['title'] as String,
                          ...
                          onChanged: (text) => NotesController.instance.nota = text,
                        ) 
                   ),
                   LabelButtonNavegation(
                     text: "Cadastrar", 
                     onChanged: (context) => NotesController.instance.registerNote(context),
                   ),
                   SizedBox(height: 10),
                ],
              ),
